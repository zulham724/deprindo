...
(function ($) {
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        success: function (msg) {
                            ...
                            if (msg === "Success") {
                                result =
                                    "Pendaftaran Berhasil, Tunggu Review dari Admin Kami";
                                cls = "alert-success";
                            } else {
                                result =
                                    "Pendaftaran Gagal, Mohon Ulangi Kembali";
                                cls = "alert-danger";
                            }
                            $(".flat-input").remove();
                            $form.prepend(
                                $("<div />", {
                                    class: "alert alert-block " + cls,
            ...
            if (matchMedia("only screen and (min-width: 1199px)").matches) {
                if ($("section").hasClass("blancejqurey")) {
                    $(".wrap-blance").each(function () {
                        ...
                        document.getElementById("blance2").style.height =
                            h + "px";
                    });
                }
                ...
                if ($("section").hasClass("blancejqurey2")) {
                    $(".wrap-blance").each(function () {
                        var h = document.getElementById("blance-s1")
                            .offsetHeight;

                        document.getElementById("blance-s2").style.height =
                            h + "px";
                    });
                }
            }
    ...
    //     if ($().gmap3) {
    //         var data = JSON.parse(
    //             '[{"address":"Baria Sreet,  NewYork City","content":""}]'
    //         );

    //         var data2 = JSON.parse(
    //             '[{"address":"Harvard Yard, Cambridge, Massachusetts, Hoa Kỳ","content":""}]'
    //         );
    ...
    //                                         options: {
    //                                             content:
    //                                                 "<div class='infobox clearfix'><div class='img-map float-left'><img src='images/maps/f1.jpg' alt='image'></div><div class='info-map'><h5>40 Baria Sreet,<br> NewYork City, US</h5></div><div class='clearfix'></div></div>",
    ...
    //                                         options: {
    //                                             content:
    //                                                 "<div class='infobox style2 text-center'><div class='info-map'><h5>40 Baria Sreet, NewYork<br>City, US</h5></div><div class='clearfix'></div></div>",
